...
const { shortTime, shortDate, zonedTime, europeanDate } = require('@utils/custom-nunjucks-filters/datetime')
...
function initialiseGlobalMiddleware(app) {
  ...
  app.use(function (req, res, next) {
    ...
    res.locals.EnvironmentFeatures = Features
    noCache(res)
    next()
  })
...
function initialiseTemplateEngine(app) {
  ...
  nunjucksEnvironment.addFilter('shortDate', shortDate)
  nunjucksEnvironment.addFilter('shortTime', shortTime)
  nunjucksEnvironment.addFilter('zonedTime', zonedTime)
